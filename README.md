...
![Lines](https://img.shields.io/badge/Lines-268-ffb800?style=for-the-badge)
...
```mermaid
graph TB
    A[Supervisor Panel] --> B[index.html]
    A --> C[style.css]
    A --> D[script.js]
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-supervisor-panel.git

# Oeffnen
cd dkz-supervisor-panel
